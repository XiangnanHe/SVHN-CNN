...
class Regions:
    ...
    def __init__(self, image, boxes, cropper=Crop_No_Padding()):
        self._image = image
        self._boxes = boxes
        self.CropImg = cropper
    ...
    def _crop(self, box):
        patch = self.CropImg.crop(self._image, box)
        return patch
...
class MSER_proposer(Reg_proposer):
